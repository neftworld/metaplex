export const auctionHouseIdl: any = {
  version: '1.1.6',
  name: 'auction_house',
  instructions: [
    {
      ...
      accounts: [
        ...
        { name: 'feeWithdrawalDestination', isMut: true, isSigner: false },
    ...
    },
    {
      ...
      accounts: [
        ...
        { name: 'authority', isMut: false, isSigner: true },
        { name: 'treasuryWithdrawalDestination', isMut: true, isSigner: false },
  ...
  errors: [
    ...
    { code: 6001, name: 'InvalidMintAuthority', msg: 'InvalidMintAuthority' },
    { code: 6002, name: 'UninitializedAccount', msg: 'UninitializedAccount' },
    ...
    { code: 6012, name: 'NoPayerPresent', msg: 'No payer present on this txn' },
    { code: 6013, name: 'DerivedKeyInvalid', msg: 'Derived key invalid' },
    { code: 6014, name: 'MetadataDoesntExist', msg: "Metadata doesn't exist" },
    { code: 6015, name: 'InvalidTokenAmount', msg: 'Invalid token amount' },
    {
      code: 6016,
